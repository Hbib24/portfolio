        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-solid-bg">
          ...
          >
            ...
            <li>
              <button
                @click="toggleDarkMode"
                class="inline-flex items-center cursor-pointer p-2 rounded hover:bg-gray-100 md:hover:bg-transparent dark:hover:bg-gray-700 md:dark:hover:bg-transparent"
              >
                <svg
                  v-if="darkMode"
                  key="sun"
